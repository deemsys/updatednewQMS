...
<table cellpadding="0" cellspacing="0" border="0" width="98%" class="margin_table">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr class="row1">
				                 ...
				                 <select name="process" id="id_inpprocess" onchange="doAjaxPost_for_process();" class="input_cmbbx1" style="width:200px;">
               					...
               					</select><br/><span class="err"><form:errors path="InternalAudits.process"></form:errors></span>
				                   	</td>	
						         </tr> 
			<tr class="row2">
               <tr class="row1">
 ...
 <table cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr class="row1">
				  ...
				  <td valign="top" align="left"><input type="submit"  value="Update" class="submit_btn1">
				 </td>
                  </tr>
                  </table>
                  </table>
