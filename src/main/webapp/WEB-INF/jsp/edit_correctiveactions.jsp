        ...
        <td valign="top" align="left">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
               ...
               <tr class="row2">
                  ...
                  <td valign="middle" align="left" class="input_txt" width="30%">SOURCE OF NONCONFORMANCE :</td>
			 ...
			 <tr class="row1">
                  ...
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="request_date" class="input_txtbx" id="datepicker2" onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value="${correctiveAndPreventiveActions.request_date}" /><span class="err"><form:errors path="CorrectiveAndPreventiveActions.request_date"></form:errors></span></td>
   				  <td valign="middle" align="left" class="input_txt" id="why?" width="20" style="display:none;"></td>
             ...
             <td valign="top" align="left" class="input_txt" width="70%"> <input name="attachments"  type="file"  /> <c:out value="${correctiveAndPreventiveActions.attachment_name}" ></c:out></td>
                 
                   </tr>
              <tr class="row1">
                  <td valign="top" align="left" class="input_txt" width="30%">Action</td>
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="action" value="<c:out value="${correctiveAndPreventiveActions.action}"/>"/><br/><span class="err"></span></td>
                  <td valign="middle" align="left" class="input_txt" width="30%">Due Date</td>
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="due_date" id = "datepicker4"value="<c:out value="${correctiveAndPreventiveActions.due_date}"/>"/><c:out value="${due_date}"/><br/><span class="err"></span></td>
              </tr>
              <tr class="row2">
                 ...
                 <tr class="row1">    
                  ...
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="completion_date" id = "datepicker5"value="<c:out value="${correctiveAndPreventiveActions.completion_date}"/>"/><c:out value="${completion_date}"/><br/><span class="err"></span></td>
                <td valign="middle" align="left" class="input_txt" width="30%">Verification Date</td>
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="verification_date" id = "datepicker6"value="<c:out value="${correctiveAndPreventiveActions.verification_date}"/>"/><br/><span class="err"></span></td>
