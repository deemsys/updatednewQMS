        ...
        <td valign="top" align="left">
            ...
            <tr class="row1">
              <td valign="top" align="left" class="input_txt">Assigned Team Leader :</td>
				 ...
				 <td valign="top" align="left" class="input_txt" width="30%"><textarea class="input_txtbx" onInput="return validatename(id);" name="team_members" id="team_member" onInput="return validatename(id);" style="width:76%; height: 70px;"></textarea><br/><span style="color: red;" id="membererror"><form:errors path="CorrectiveAndPreventiveActions.team_members"></form:errors></span></td>
                <td valign="top" align="left" class="input_txt" width="30%">Root-Cause Statement :</td>               
                  <td valign="top" align="left" class="input_txt" width="30%"><textarea class="input_txtbx"  name="root_cause_statement" id="root_cause_statement" onInput="return validatename(id);" style="width:100%; height: 70px;"></textarea><br/><span style="color: red;" id="rooterror"><form:errors path="CorrectiveAndPreventiveActions.root_cause_statement"></form:errors></span></td>
