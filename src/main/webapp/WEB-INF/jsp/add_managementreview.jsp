		 ...
		 <td valign="middle" align="right" class="input_txt" width="30%">
		  ...
		  <tr class="row2">
                ...
                <tr class="row1">
                  ...
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="assessment" class="input_txtbx" id="inp_assessment" onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value='<c:out value="${managementreview.action_detail}"></c:out>' /><br/><span class="err"><form:errors path="ManagementReview.assessment"></form:errors></span></td>                
                  <td valign="middle" align="right" class="input_txt" width="30%"> REPORT LINK:</td>
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="report_link" class="input_txtbx" id="inp_report_link" onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value='<c:out value="${managementreview.report_link}"></c:out>' /><br/><span class="err"><form:errors path="ManagementReview.report_link"></form:errors></span></td>                
                  
                  </tr>
                  <tr class="row2">
			                  <td valign="top" align="left" class="input_txt"> ACTION NEEDED:</td>
			        		         <td valign="top" align="left" class="input_txt"><input type="radio" name="action_needed"  value="0" class="input_txt" checked="true">Yes&nbsp;&nbsp;&nbsp;<input type="radio" name="action_needed" value="1" class="input_txt">No
                	          <td valign="middle" align="right" class="input_txt" width="30%">
              				<td valign="top" align="left" class="input_txt" width="70%">
                  ...
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="action_detail" class="input_txtbx" id="inp_action_detail" onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value='<c:out value="${managementreview.action_detail}"></c:out>' /><br/><span class="err"><form:errors path="ManagementReview.action_detail"></form:errors></span></td>                
                  ...
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="responsibility" class="input_txtbx" id="inp_responsibility" onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value='<c:out value="${managementreview.responsibility}"></c:out>' /><br/><span class="err"><form:errors path="ManagementReview.responsibility"></form:errors></span></td>                
                  <td valign="middle" align="right" class="input_txt" width="30%"> COMPLETION DATE :</td>
                  <td valign="top" align="left" class="input_txt" width="70%"><input type="text" name="completion_date" class="input_txtbx" id="datepicker1" onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value='<c:out value="${managementreview.completion_date}"></c:out>' /><br/><span class="err"><form:errors path="ManagementReview.completion_date"></form:errors></span></td>                
                  
                  </tr>
                  
                   <tr class ="row1">
            <td valign="middle" align="right" class="input_txt" width="30%"> CONTINUOUS IMPROVEMENT PROJECT &nbsp :</td>
