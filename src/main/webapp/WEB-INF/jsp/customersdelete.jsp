					...
					<div id="success_statusbar" class="status success">
						<p class="closestatus">
							...
							<img alt="Success" src="resources/images/icons/icon_success.png"><span style="color:green;">Successfully Deleted..!</span>.
								<a title="Close" href="customersdelete" style="color:red;">X</a>
						</p>
					</div></td>
			</tr>
		</c:if>
				...
				<td valign="top" align="left"><div>
					...
					<form action="deletecustomers" name="dashboard" onsubmit="return validate()" method="POST">
							...
							<tr class="title">
								...
								<td valign="top" align="left" width="20%">Customer&nbsp;ID</td>
					         	<td valign="top" align="left" width="25%">Customer Name</td>
								<td valign="top" align="left" width="20%">Address</td>
          						<td valign="top" align="left" width="25%">Email Address</td>
								<td valign="top" align="left" width="25%">City</td>
								<td valign="top" align="left" width="35%">Telephone</td>
								...
								<% int i=1; %>
									...
									<c:forEach items="${customersForm.customers}" var="customers" varStatus="status">
							       		...
							       		<td valign="top" align="left" width="10%"><input type="checkbox" name="chkUser" value="${customers.customer_id}"/></td>
											...
											<td valign="top" align="left" width="15%">${customers.city}</td>
											<td valign="top" align="left" width="15%">${customers.telephone}</td>
